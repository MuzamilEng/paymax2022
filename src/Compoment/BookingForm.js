        ...
        <div className={style.main3_sidebar}>
          <div className={style.booking_form}>
            ...
            <div className={style.booking_form_inputs1}>
              <input
                type="date"
                className={style.booking_inputs}
            ...
            <div className={style.booking_form_inputs}>
              <div className={style.booking_form_inputs}>
                <select name="rooms" className={style.select}>
                  ...
                  <option value="small">2 bed room</option>
                  <option value="large">5 bed room</option>
                </select>
              </div>
              <div className={style.booking_form_inputs}>
                <select name="rooms" className={style.select}>
              ...
              <div className={style.booking_form_inputs}>
                <p className={style.check_time}>
                  <span className={style.bold}>Check In:</span>12:00 pm /
                  <span className={style.bold}>Check Out:</span>11:00 am
                </p>
              </div>
